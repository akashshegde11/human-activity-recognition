...
def load_data_for_persons(trg_data_root, start_index, finish_index, frames_per_clip):
...
nb_epochs = 30  # feel free to change
model.summary()
plot_model(model, "D:\Documents\KTH\Model_GRU.png")
...
plt.savefig("D:\Documents\KTH\Confusion_Matrix_GRU.png")
...
with open("D:\Documents\KTH\KTH_GRU.json", 'w') as f:
    f.write(jsonstring)
model.save_weights("D:\Documents\KTH\KTH_GRU.h5", overwrite=True)
