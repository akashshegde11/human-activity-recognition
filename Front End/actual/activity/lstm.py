...
f=open('D:\\Documents\\actual\\mit.txt','r')
m=f.readlines()
a=int(m[0])
b=int(m[1])
c=int(m[2])
...
nb_epochs = e  # feel free to change
model.summary()
...
# load training data
X_train, y_train = load_data_for_persons(trg_data_root, a, b, maxToAdd)
...
# load test data
X_test, y_test = load_data_for_persons(trg_data_root, c, d, maxToAdd)
...
plt.savefig("D:\\Documents\\actual\\activity\\static\\activity\\mit3.png")
